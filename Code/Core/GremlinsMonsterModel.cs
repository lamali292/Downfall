...
public abstract class GremlinsMonsterModel : CustomMonsterModel
{
    ...
    {
        return SetupAnimationState(controller, idleName: IdleAnimationName);
    }
...
public class AngryGremlin : GremlinsMonsterModel
{
    ...
    public override string CustomVisualPath => "res://Downfall/character/scenes/combat_scene/gremlins/angry_combat.tscn";
}

public class ShieldGremlin : GremlinsMonsterModel
{
    protected override string IdleAnimationName => "idle";
    public override string CustomVisualPath => "res://Downfall/character/scenes/combat_scene/gremlins/shield_combat.tscn";
}
...
{
    protected override string IdleAnimationName => "animation";
    public override string CustomVisualPath => "res://Downfall/character/scenes/combat_scene/gremlins/sneak_combat.tscn";
}

public class WizardGremlin : GremlinsMonsterModel
{
    protected override string IdleAnimationName => "animation";
    public override string CustomVisualPath => "res://Downfall/character/scenes/combat_scene/gremlins/wizard_combat.tscn";
}